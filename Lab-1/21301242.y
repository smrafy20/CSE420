...
int main(int argc, char *argv[])
{
	if(argc != 2) 
	{
		cerr << argv[0] << " The input filename is missing or given incorrectly in the last line of script.sh" << endl; // check if filename given
		return 0;
	}
	yyin = fopen(argv[1], "r");
	...
	outlog << "Total lines parsed: " << lines << endl; //print number of lines
